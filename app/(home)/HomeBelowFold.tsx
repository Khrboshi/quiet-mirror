        ...
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
            {[
              {
                quote:
                  "You're always checking in on everyone else. No one ever asks how you are.",
                accent: "border-violet-500/20 bg-violet-500/[0.04]",
                dot: "bg-violet-400",
              },
              {
                quote:
                  "You know something keeps happening in your life. You just can't see what.",
                accent: "border-emerald-500/20 bg-emerald-500/[0.04]",
                dot: "bg-emerald-400",
              },
              {
                quote:
                  "You've tried journaling before. You want to - but you never know what to say.",
        ...
        <div className="mx-auto max-w-6xl px-5">
          <div className="mb-8 max-w-lg">
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-500">
              ...
              honest &mdash; and something that pays attention.
            </p>
          </div>
            ...
            {[
              {
                ...
                body:
                  "You don't need to be a writer. Just open Havenly and say what's actually going on. Messy, incomplete &mdash; it doesn't matter. Havenly pays attention so you don't have to.",
              ...
              },
              {
                ...
                body:
                  "Havenly reads what you wrote and offers a gentler version of what it heard &mdash; the emotions underneath, the patterns surfacing, the things you couldn't quite name.",
              ...
              },
              {
                ...
                body:
                  "Over weeks, Havenly shows you what keeps coming up &mdash; what drains you, what lifts you, what you keep circling back to without realising it.",
              ...
              >
                ...
                <h3 className="mt-2 text-[15px] font-medium text-white sm:text-sm">
                  {title}
                </h3>
                <p
        ...
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              {
                quote:
                  "I didn't realise how much I was carrying until I started writing it down. Havenly noticed patterns in my entries that I genuinely couldn't see myself.",
                name: "M.L.",
                detail: "6 weeks in",
              },
              {
                quote:
                  "I've tried journaling apps before and always stopped after a week. This one feels different &mdash; it actually responds to what I write instead of just storing it.",
                name: "T.A.",
                detail: "3 months in",
              },
              {
                quote:
                  "The weekly summary is the part I look forward to most. It's like having someone who's been quietly paying attention tell you what they noticed.",
                name: "R.K.",
              ...
              >
                ...
                <div className="mt-4 flex items-center gap-2">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-700 text-[10px] font-semibold text-slate-400">
                    {name[0]}
                  </div>
                  <div>
      ...
      <section className="border-b border-slate-800/60 bg-slate-950 py-12 sm:py-20">
        <div className="mx-auto max-w-6xl px-5">
          <div className="mb-8 max-w-lg">
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-500">
              Not summaries of your day. The things that are harder to see from
              the inside.
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                example:
                  "Hope, Openness, and Curiosity all rising &mdash; something is lifting",
              ...
              },
              {
                ...
                example:
                  "A personal paragraph written just for you &mdash; what Havenly noticed this week across all your entries",
              ...
              },
              {
                ...
                example:
                  "&quot;What would it mean to stop saying you're fine &mdash; just for today?&quot;",
              ...
              >
                ...
                <p
                  className="mt-2 text-sm italic leading-relaxed text-slate-400 sm:text-xs"
          ...
          <div className="flex flex-col-reverse gap-4 md:grid md:grid-cols-2 md:gap-5">
            <div className="flex flex-col rounded-2xl border border-slate-800 bg-slate-900/40 p-5 sm:p-6">
              ...
              <p className="mt-2 text-sm text-slate-500">
                A calm place to write honestly &mdash; no commitment, no
                pressure, no audience.
              </p>
            ...
            <div className="relative flex flex-col rounded-2xl border border-emerald-500/25 bg-emerald-500/[0.04] p-5 sm:p-6">
              ...
              <div className="mt-4 space-y-1 rounded-xl border border-slate-700/60 bg-slate-900/50 p-3 text-xs text-slate-400">
                <p>
                  <span className="text-slate-600">Before:</span> You know
                  something keeps happening. You cannot quite see what.
                </p>
                <p>
                  <span className="text-emerald-500/80">After:</span> Havenly
                  shows you the pattern &mdash; and how long it has been there.
                </p>
              </div>
              ...
              <div className="mt-auto flex flex-col gap-2 pt-6">
                ...
                <Link
                  href="/insights/preview"
                  className="inline-flex w-full items-center justify-center rounded-full border border-slate-700 px-5 py-2.5 text-xs font-medium text-slate-400 transition-colors hover:bg-slate-900"
                >
        ...
        <div className="mx-auto max-w-3xl px-5">
          ...
          <div className="mt-6 space-y-5 sm:mt-7 sm:space-y-6">
            {[
              {
                q: "Is this therapy?",
                a: "No. Havenly is a journaling companion &mdash; it can sit alongside therapy, coaching, or your own personal practices, but it is not a clinical tool and cannot replace professional support.",
              },
              {
                q: "Do I have to write every day?",
                a: "Not at all. Some people check in a few times a week. Others only when life feels particularly full. The patterns Havenly notices get richer over time, but there is no pressure.",
              },
              {
                q: "What happens to my journal entries?",
                a: "They are yours. Stored securely, never used to train AI models, never shared. Havenly is built around the idea that your inner life belongs to you &mdash; not the internet.",
              },
              {
                q: "What makes Premium worth $30/month?",
                a: "Free gives you a private space to write and reflect. Premium gives you the full picture &mdash; what repeats across weeks and months, a personal weekly summary written just for you, and the hidden patterns you cannot see from inside them.",
              },
            ].map(({ q, a }) => (
      ...
      <section className="border-t border-slate-800/60 bg-slate-950 py-12 sm:py-14">
        <div className="mx-auto max-w-3xl px-5 text-center">
          ...
          <p className="mx-auto mt-3 max-w-sm text-sm text-slate-500 sm:max-w-md">
            Start with a single entry. No pressure, no performance. Just write
          ...
          <div className="mt-6 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-center">
            ...
            <Link
              href="/blog"
              className="inline-flex items-center justify-center rounded-full border border-slate-700 px-7 py-3.5 text-[15px] font-medium text-slate-400 transition-colors hover:bg-slate-900 sm:py-3 sm:text-sm"
            >
