        ...
        <div className="mt-10 space-y-10 text-sm" role="article" aria-label="Privacy policy details">
          ...
          <section id="what-we-collect" aria-labelledby="what-we-collect-heading">
            ...
            <ul className="mt-3 list-disc space-y-2 ps-5 text-qm-secondary">
              ...
              <li>
                ...
                metadata), plus analytics and session recordings of our public
                pages as described under{" "}
          ...
          <section id="cookies" aria-labelledby="cookies-heading">
            ...
            <p className="mt-3 text-qm-secondary">
              ...
              This covers page views, sign-up steps, and session recordings of
              our public pages — the home page, About, Blog, Pricing, and the
              sign-in page.
            </p>
            <p className="mt-3 text-qm-secondary">
              Session recordings never cover the journal itself. Recording is
