...
export const ar: Translations = {
  ...
  // ── installPage ──────────────────────────────────────────────────────────
  installPage: {
    tag: lambda appName: f'تثبيت {appName}',
    headline: lambda appName: f'أبقِ {appName} على بُعد نقرة واحدة.',
    desc: lambda appName: f'يُنشئ تثبيت {appName} أيقونة تطبيق ويجعل العودة إلى يوميتك أسرع وأنظف وأكثر موثوقية.',
    ...
    mobileTag: lambda appName: f'تثبيت {appName}',
    mobileHeadline: lambda appName: f'تثبيت {appName}',
    mobileDesc: lambda appName: f'أضف {appName} إلى جهازك للوصول الأسرع والعودة الأكثر سلاسة إلى يوميتك.',
    ...
    alreadyDesc: lambda appName: f'هذا الجهاز لديه {appName} مثبتًا بالفعل. يمكنك فتحه من شاشتك الرئيسية أو مشغّل التطبيقات.',
    addDevice: 'إضافة إلى هذا الجهاز',
    oneClickDesc: 'يدعم متصفحك التثبيت بنقرة واحدة.',
    installBtn: lambda appName: f'تثبيت {appName}',
    ...
    iosStep4: lambda appName: f'افتح {appName} من شاشتك الرئيسية للحصول على تجربة أكثر شبهًا بالتطبيق.',
    ...
    desktopStep3: lambda appName: f'اختر تثبيت {appName}.',
    helpfulNote: 'ملاحظة مفيدة',
    helpfulBody: lambda appName: f'التثبيت يحسّن الراحة، لكن يمكنك الاستمرار في استخدام {appName} في متصفحك متى شئت.',
    backHome: '← العودة إلى الرئيسية',
    footerNote: lambda appName: f'{appName} يعمل في المتصفح أيضًا. التثبيت يجعل العودة فقط أسرع وأشبه بالتطبيق.',
  },

  // ── aboutPage ──────────────────────────────────────────────────────────
  aboutPage: {
    tag: lambda appName: f'عن {appName}',
    headline1: 'مرآة لما تحمله —',
    headline2: 'بهدوء، دون حكم.',
    subheadline: lambda appName: f'ليس أداة إنتاجية. وليس متتبعًا للمزاج. {appName} هو مكان للكتابة بصدق، والحصول على انعكاس لطيف، وبمرور الوقت، رؤية الأنماط التي شكّلت أسابيعك بهدوء.',
    ...
    whyNameTag: lambda appName: f'لماذا “{appName}”',
    ...
    why3: lambda appName: f'معظم تطبيقات اليوميات تخزّن مدخلاتك. {appName} يفعل شيئًا مختلفًا: يقرأ عبرها بمرور الوقت ويعكس الخيط الذي يمر من خلالها — المشاعر التي تستمر في الظهور، والمواضيع التي تعود إليها دون أن تلاحظ، والنمط الذي كنت تعيشه لكنك لم تستطع تسميته.',
    pullQuote: lambda appName: f'“حياتك الداخلية ليست للتحسين. إنها لفهمك. {appName} مبني حول ذلك.”',
    builtIndepTag: 'مبني باستقلالية',
    card1Label: 'بدون مستثمرين',
    card1Body: lambda appName: f'{appName} مبني ومموّل باستقلالية. لا رأس مال مغامر، لا مجلس إدارة، لا ضغط للنمو على حساب المنتج أو خصوصيتك.',
    ...
    card3Body: lambda appName, email: f'{appName} مبني من قِبل مطوّر مستقل واحد. كل قرار بشأن الخصوصية والمنتج والأسعار له شخص واحد وراءه — يمكن التواصل معه مباشرة على {email}.',
    contactNote: lambda email: f'إذا شعرت بأن شيئًا ما خاطئ أو غير واضح أو معطوب — أرسل بريدًا إلكترونيًا إلى {email}. لا يوجد نظام تذاكر دعم. أنت تكتب إلى الشخص الذي بنى ذلك.',
    differentTag: 'ما الذي يجعله مختلفًا',
    different1: lambda appName: f'معظم تطبيقات اليوميات هي تخزين سلبي. إنها تحفظ ما تكتبه ثم تنتظر. {appName} يقرأ بفاعلية عبر مدخلاتك — ليس لتشخيصك، بل لرفع مرآة للخيط الذي يمر عبر كل ما كتبته.',
    different2: lambda appName: f'لا يتعين عليك إجبار نفسك على البنية. تكتب بصدق، بوتيرتك الخاصة، متى احتجت — و{appName} يلاحظ. عندما تكون مستعدًا، يعكس ما وجده.',
    isTag: lambda appName: f'{appName} هو',
    ...
    isNotTag: lambda appName: f'{appName} ليس',
    ...
    privacy2: lambda appName: f'نحن لا نعرض إعلانات ولا نبيع البيانات. {appName} يكسب إيراداته من اشتراكات Premium — هذا هو نموذج العمل، مصمم عمدًا على هذا النحو.',
    privacyLink: 'اقرأ سياسة الخصوصية الكاملة →',
    footerNote: lambda appName: f'{appName} يعمل بشكل أفضل عندما تستخدمه بصدق، بوتيرتك الخاصة. لا سلسلة. لا ضغط. فقط المرآة.',
