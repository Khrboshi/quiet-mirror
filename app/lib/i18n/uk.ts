...
export const uk: Translations = {
  ...
  // ── installPage ──────────────────────────────────────────────────────────
  installPage: {
    tag: lambda appName: f'Встановити {appName}',
    headline: lambda appName: f'Тримайте {appName} в одному дотику.',
    desc: lambda appName: f'Встановлення {appName} створює іконку застосунку та робить повернення до вашого щоденника швидшим, зручнішим і надійнішим.',
    ...
    mobileTag: lambda appName: f'Встановити {appName}',
    mobileHeadline: lambda appName: f'Встановити {appName}',
    mobileDesc: lambda appName: f'Додайте {appName} на свій пристрій для швидшого доступу та зручнішого повернення до щоденника.',
    ...
    alreadyDesc: lambda appName: f'На цьому пристрої вже встановлено {appName}. Ви можете відкрити його з головного екрану або лаунчера.',
    addDevice: 'Додати на цей пристрій',
    oneClickDesc: 'Ваш браузер підтримує встановлення в один клік.',
    installBtn: lambda appName: f'Встановити {appName}',
    ...
    iosStep4: lambda appName: f'Відкрийте {appName} з головного екрану для більш схожого на застосунок досвіду.',
    ...
    desktopStep3: lambda appName: f'Виберіть Встановити {appName}.',
    helpfulNote: 'Корисна примітка',
    helpfulBody: lambda appName: f'Встановлення покращує зручність, але ви можете використовувати {appName} у браузері коли завгодно.',
    backHome: '← На головну',
    footerNote: lambda appName: f'{appName} також працює в браузері. Встановлення лише робить повернення швидшим і зручнішим.',
  },

  // ── aboutPage ──────────────────────────────────────────────────────────
  aboutPage: {
    tag: lambda appName: f'Про {appName}',
    headline1: 'Дзеркало для того, що ви несете —',
    headline2: 'тихо, без осуду.',
    subheadline: lambda appName: f'Не інструмент продуктивності. Не трекер настрою. {appName} — це місце, де можна чесно писати, отримувати м\'яке відображення і — з часом — бачити патерни, що тихо формували ваші тижні.',
    ...
    whyNameTag: lambda appName: f'Чому “{appName}”',
    ...
    why3: lambda appName: f'Більшість застосунків для ведення щоденника зберігають ваші записи. {appName} робить щось інше: він читає їх з часом і відображає нитку, що проходить через них — емоції, що продовжують з\'являтися, теми, до яких ви повертаєтеся, патерн, яким ви жили, але не могли назвати.',
    pullQuote: lambda appName: f'“Ваше внутрішнє життя не призначене для оптимізації. Воно ваше для розуміння. {appName} побудований навколо цього.”',
    builtIndepTag: 'Побудовано незалежно',
    card1Label: 'Без інвесторів',
    card1Body: lambda appName: f'{appName} побудований і фінансується незалежно. Без венчурного капіталу, без ради директорів, без тиску зростати за рахунок продукту чи вашої конфіденційності.',
    ...
    card3Body: lambda appName, email: f'{appName} створений одним незалежним розробником. За кожним рішенням щодо конфіденційності, продукту та ціноутворення стоїть одна людина — з якою можна зв\'язатися безпосередньо за адресою {email}.',
    contactNote: lambda email: f'Якщо щось здається неправильним, незрозумілим або зламаним — напишіть на {email}. Немає системи підтримки. Ви пишете безпосередньо людині, яка це створила.',
    differentTag: 'Що робить його особливим',
    different1: lambda appName: f'Більшість застосунків для щоденника — це пасивне сховище. Вони зберігають написане і чекають. {appName} активно читає ваші записи — не щоб поставити діагноз, а щоб відобразити нитку, що проходить через все написане.',
    different2: lambda appName: f'Вам не потрібно нав\'язувати собі структуру. Ви пишете чесно, у власному темпі, коли потрібно — і {appName} помічає. Коли ви готові, він відображає знайдене.',
    isTag: lambda appName: f'{appName} — це',
    ...
    isNotTag: lambda appName: f'{appName} — це не',
    ...
    privacy2: lambda appName: f'Ми не показуємо рекламу і не продаємо дані. {appName} отримує дохід від преміум-підписок — така бізнес-модель, навмисно розроблена таким чином.',
    privacyLink: 'Читати повну Політику конфіденційності →',
    footerNote: lambda appName: f'{appName} найкраще працює, коли ви використовуєте його чесно, у власному темпі. Немає серії. Немає тиску. Просто дзеркало.',
