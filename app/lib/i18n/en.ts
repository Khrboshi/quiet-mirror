...
export const en: Translations = {
  ...
  homepage: {
    metaTitle:        (appName) => `${appName} — A Private Journal for Seeing Patterns`,
    metaDescription:  "Write naturally, get a grounded reflection, and notice patterns across your entries. Private early access with full access and no charge.",
    ogTitle:          (appName) => `${appName} — A Private Journal for Seeing Patterns`,
    ogDescription:    "Write naturally. Get a grounded reflection. Notice what keeps returning over time.",
    ...
    heroDesc:         "Quiet Mirror is a private journal that gives you a grounded reflection on what you write, then helps you notice patterns across your entries over time.",
  ...
  homeBelowFold: {
    ...
    trust3Title:"No data business",trust3Body:"Quiet Mirror is designed to earn from subscriptions, not from selling or sharing your private writing.",
    ...
    pricingTag:"Early access",pricingH:"Full access while Quiet Mirror is being shaped.",
    pricingDesc:"Early-access members get the complete experience at no charge while we improve the product with a small group of thoughtful testers.",
