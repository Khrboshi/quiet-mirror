...
export const metadata = {
  ...
  description: "The private journal that listens, remembers, and helps you connect the dots. No advice, no noise — just clarity. Free to start.",
  openGraph: {
    title: "Havenly — Stop Carrying It All in Your Head",
    description: "The private journal that listens, remembers, and helps you connect the dots. Free to start.",
